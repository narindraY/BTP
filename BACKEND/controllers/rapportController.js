...
exports.generateRapportJournalier = (req, res) => {
  ...
  doc.text("Projet : Construction École Primaire");
  ...
  const sql = `
    ...
    FROM SUIVI s
    INNER JOIN TACHE t
      ON s.tache_id = t.id_tache
    INNER JOIN PROJET p
      ON t.projet_id = p.id_projet
  ...
  db.query(sql, (err, rows) => {
    ...
    doc.text(
      "Chef de chantier : __________________",
      30,
      y + 40
    );
