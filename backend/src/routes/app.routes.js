...
const { createPub, listPub, editPub, removePub } = require("../controllers/publication.controller");
...
router.put("/publication/:id", upload.single("img"), editPub);
router.delete("/publication/:id", removePub);
...
router.get('/:id/suivis', projectController.getProjectSuivis);
...
// Client
router.get("/client/mes-projets", auth, clientController.getClientProjects);
router.post("/client/demande", auth, clientController.createDemande);
