...
export default function Chat() {
  ...
  const openDiscussion = async (disc) => {
    ...
    if (window.innerWidth < 768) setShowDiscussions(false);
  };
  ...
  return (
    <div className="relative flex h-full min-h-0 bg-gray-50 rounded-2xl overflow-hidden shadow-xl border border-gray-200/80">
      ...
      {/* Zone principale */}
      <div className="flex-1 flex flex-col bg-white overflow-hidden min-w-0 min-h-0 relative">
        {!selected ? (
          ...
          <>
            {/* En-tête */}
            <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between bg-white shadow-sm z-10 flex-shrink-0">
            ...
            {/* Messages */}
            <div className="flex-1 min-h-0 overflow-y-auto p-4 md:p-5 bg-gradient-to-b from-gray-50/30 to-gray-100/30 custom-scrollbar"
            ...
            {/* Input */}
            <form onSubmit={send} className="px-4 py-3 border-t border-gray-100 bg-white flex-shrink-0">
              {editId && (
